...
const SchemaEditor: React.FC<SchemaEditorProps> = ({
        ...
        if (mutation.attributeName === 'class') {
          ...
          if (editorRef.current && monacoRef.current) {
            editorRef.current.updateOptions({
              theme: isDark ? 'zodDarkTheme' : 'zodLightTheme'
            });
          }
        }
      });
  ...
  const handleEditorChange = (value: string | undefined) => {
    ...
    // Check for syntax errors if not in read-only mode
    if (!readOnly) {
  ...
  const handleEditorBeforeMount = (monaco: typeof import('monaco-editor')) => {
    ...
    // Define a light theme for Zod with enhanced syntax highlighting
    monaco.editor.defineTheme('zodLightTheme', {
      ...
      rules: [
        ...
        { token: 'zod-property', foreground: '#ca5010', fontStyle: 'bold' },
    ...
    // Define a dark theme for Zod with enhanced syntax highlighting
    monaco.editor.defineTheme('zodDarkTheme', {
      ...
      rules: [
        ...
        { token: 'zod-property', foreground: '#e67e22', fontStyle: 'bold' },
    ...
    // Register a tokens provider for the language with enhanced syntax highlighting
    monaco.languages.setMonarchTokensProvider('zod', {
      tokenizer: {
        root: [
          ...
          // Regular expressions
          [/\/(?=([^\\\/]|\\.)+\/)/, { token: 'regex', next: '@regex' }],

          // Keywords
          [/\b(const|let|var|function|return|if|else|for|while|switch|case|break|continue|new|this|typeof|instanceof|import|export|from|as|class|interface|extends|implements|get|set|static|public|private|protected|readonly|async|await|try|catch|finally|throw|yield|delete|in|of|with|void|null|undefined)\b/, 'keyword'],

          // Types
          [/\b(string|number|boolean|any|unknown|never|object|symbol|bigint|Date|RegExp|Promise|Array|Map|Set|WeakMap|WeakSet)\b/, 'type'],
    ...
    <div>
      <div className="border border-gray-300 dark:border-gray-600 rounded-md overflow-hidden">
        <Editor
          ...
          theme={isDarkTheme ? 'zodDarkTheme' : 'zodLightTheme'}
          options={{
          ...
          onMount={(editor) => {
            ...
            // Validate initial schema if any and not in read-only mode
            if (value && !readOnly) {
